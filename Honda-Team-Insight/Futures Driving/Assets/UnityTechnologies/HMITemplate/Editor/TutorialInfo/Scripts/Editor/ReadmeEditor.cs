        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Instrument Cluster (2560x1080)"))
            {
                UnityEngine.SceneManagement.Scene scene =
                    EditorSceneManager.OpenScene(@"Assets/UnityTechnologies/HMITemplate/Scenes/Cluster.unity");
            }

            if (GUILayout.Button("Main Unit (1920x1080)"))
            {
                UnityEngine.SceneManagement.Scene scene =
                    EditorSceneManager.OpenScene(@"Assets/UnityTechnologies/HMITemplate/Scenes/IVI.unity");
            }

            if (GUILayout.Button("HVAC (1920x1080)"))
            {
                UnityEngine.SceneManagement.Scene scene =
                    EditorSceneManager.OpenScene(@"Assets/UnityTechnologies/HMITemplate/Scenes/HVAC.unity");
            }
