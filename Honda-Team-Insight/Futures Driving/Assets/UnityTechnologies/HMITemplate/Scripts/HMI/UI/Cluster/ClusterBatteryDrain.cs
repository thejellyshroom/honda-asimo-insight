...
{
    /// <summary>
    /// The battery draing progress bar shows how much energy is being drained from the battery
    /// </summary>
    [RequireComponent(typeof(SpriteRenderer))]
    public class ClusterBatteryDrain : MonoBehaviour
    {
        /// <summary>
        /// Maximum of the scale that usage is shown on
        /// </summary>
        public float MaxUsage = 50f;
